...
function EasterEgg({ found, onClose }) {
  ...
  useEffect(() => {
    ...
    const timers = terminalMessages.map((_, index) => {
      return setTimeout(() => {
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (event) => {
      ...
      if (stage === "decode") {
        ...
        /*
         * Allow M to return to menu
         * only when the answer input
  ...
  const handleDecodeSubmit = () => {
    const answer = decodeInput.trim().toLowerCase();
    ...
    if (decodeLevel === 1) {
      ...
      if (answer === "hello") {
        ...
        setDecodeResult("level1-success");
          ...
          {stage === "investigate" && (
            <div className="secret-investigation">
              ...
              <p>
                ...
                <strong>
                  {" "}
                  Apparently the shortest path wasn't the point.
                </strong>
              </p>
